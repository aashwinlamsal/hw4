...
For the first overview, I'll plot a scatterplot of the lattitude and longitudes of store locations
```{r}
library(ggplot2)

ggplot(newData, aes(x=newData$lattitude, y=newData$longitude)) + geom_point() + labs(x = "Lattitude", y= "Longitude", title = "Spread of Liquor Store Locations by Lattitude and Longitude")
